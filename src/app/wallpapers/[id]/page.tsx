...
function DownloadAllCard({
	...
	return (
		<a
			...
			className={categoryStyles.cardLink}
			style={pointerStyle}
		...
		>
			<WallpaperCard
				...
				imageWrapperClassName={categoryStyles.collageWrapper}
				imageSlot={
					<div className={categoryStyles.collageGrid}>
						{previewSources.map((src, idx) => (
							<div className={categoryStyles.collageTile} key={`${src}-${idx}`}>
								<Image
									src={src}
									alt={previewContext}
									fill
